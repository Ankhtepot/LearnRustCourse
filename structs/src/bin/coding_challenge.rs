...
fn main() {
    ...
    let mut flight = Flight::new(String::from("LHR"), String::from("AMS"), 100.0, 2);

    flight.change_destination(String::from("PRG"));
    ...
    let flight2 = Flight {
        origin: String::from("AMS"),
        destination: String::from("PRG"),
        ..flight
    };
    println!("{flight2:#?}");
}
